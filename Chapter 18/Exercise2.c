...
(b) Suppose that a variable x is to be shared by several function in one file
but hidden from functions in other files. Which storage class should x be declared to have?
static
